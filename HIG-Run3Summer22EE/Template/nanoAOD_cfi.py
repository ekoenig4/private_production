...
# with command line options: --filein file:3_HIG-Run3Summer22EEMiniAODv4.root --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step NANO --scenario pp --era Run3 --no_exec --mc --python_filename 4_HIG-Run3Summer22EENanoAODv12.py --fileout file:4_HIG-Run3Summer22EENanoAODv12.root -n 10
