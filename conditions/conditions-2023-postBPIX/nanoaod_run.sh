...
build_cmssw 13_0_13
run 0_HIG-Run3Summer23BPixwmLHEGS \
    Configuration/GenProduction/python/fragment.py \
    --fileout "file:0_HIG-Run3Summer23BPixwmLHEGS.root" \
...
export SCRAM_ARCH=el8_amd64_gcc10
build_cmssw 13_0_13
run 1_HIG-Run3Summer23BPixDRPremix \
    --filein "file:0_HIG-Run3Summer23BPixwmLHEGS.root" \
    --fileout "file:1_HIG-Run3Summer23BPixDRPremix.root" \
    --eventcontent PREMIXRAW \
    --customise Configuration/DataProcessing/Utils.addMonitoring \
    --datatier GEN-SIM-RAW \
    --pileup_input "dbs:/Neutrino_E-10_gun/Run3Summer21PrePremix-Summer23BPix_130X_mcRun3_2023_realistic_postBPix_v1-v1/PREMIX#3cfdd519-2519-4450-9354-33fff5d6790a" \
    --conditions 130X_mcRun3_2023_realistic_postBPix_v2 \
...
export SCRAM_ARCH=el8_amd64_gcc10
build_cmssw 13_0_13
run 2_HIG-Run3Summer23BPixAOD \
    --filein "file:1_HIG-Run3Summer23BPixDRPremix.root" \
    --fileout "file:2_HIG-Run3Summer23BPixAOD.root" \
    --eventcontent AODSIM \
    --customise Configuration/DataProcessing/Utils.addMonitoring \
    --datatier AODSIM \
    --conditions 130X_mcRun3_2023_realistic_postBPix_v2 \
...
build_cmssw 13_0_13
run 3_HIG-Run3Summer23BPixMiniAODv4 \
    --filein "file:2_HIG-Run3Summer23BPixAOD.root" \
    --fileout "file:3_HIG-Run3Summer23BPixMiniAODv4.root" \
...
export SCRAM_ARCH=el8_amd64_gcc11
build_cmssw 13_0_13
run 4_HIG-Run3Summer23BPixNanoAODv12 \
    --filein "file:3_HIG-Run3Summer23BPixMiniAODv4.root" \
