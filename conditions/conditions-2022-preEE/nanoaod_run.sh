...
export SCRAM_ARCH=el8_amd64_gcc10
build_cmssw 12_4_14_patch3
run 1_HIG-Run3Summer22DRPremix \
    --filein "file:0_HIG-Run3Summer22wmLHEGS.root" \
    --fileout "file:1_HIG-Run3Summer22DRPremix.root" \
    --eventcontent PREMIXRAW \
    --customise Configuration/DataProcessing/Utils.addMonitoring \
    --datatier GEN-SIM-RAW \
    --pileup_input "dbs:/Neutrino_E-10_gun/Run3Summer21PrePremix-Summer22_124X_mcRun3_2022_realistic_v11-v2/PREMIX#13ee937a-b4ef-4844-829f-8d217be6cf70" \
    --conditions 124X_mcRun3_2022_realistic_v12 \
...
export SCRAM_ARCH=el8_amd64_gcc10
build_cmssw 12_4_14_patch3
run 2_HIG-Run3Summer22AOD \
    --filein "file:1_HIG-Run3Summer22DRPremix.root" \
    --fileout "file:2_HIG-Run3Summer22AOD.root" \
    --eventcontent AODSIM \
    --customise Configuration/DataProcessing/Utils.addMonitoring \
    --datatier AODSIM \
    --conditions 124X_mcRun3_2022_realistic_v12 \
...
build_cmssw 13_0_13
run 3_HIG-Run3Summer22MiniAODv4 \
    --filein "file:2_HIG-Run3Summer22AOD.root" \
    --fileout "file:3_HIG-Run3Summer22MiniAODv4.root" \
...
export SCRAM_ARCH=el8_amd64_gcc11
build_cmssw 13_0_13
run 4_HIG-Run3Summer22NanoAODv12 \
    --filein "file:3_HIG-Run3Summer22MiniAODv4.root" \
